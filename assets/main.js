...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#image03', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text36', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > *', replay: false });
